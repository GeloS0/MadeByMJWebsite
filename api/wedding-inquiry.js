...
module.exports = async (req, res) => {
  ...
  const coupleHtml = shell(`
    ...
    <p style="margin:22px 0 0;font-size:14px;line-height:1.7;color:rgba(17,8,32,.6);">Anything on your mind before then? Just reply here, or text us at (978) 364-4344.<br/><br/>With care,<br/><strong style="color:${INK};font-weight:500;">MJ &amp; Gelo — Made by MJ</strong></p>
  `);
